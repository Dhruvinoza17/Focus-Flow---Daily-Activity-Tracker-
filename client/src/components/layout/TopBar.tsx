...
export const TopBar = () => {
    ...
    return (
        <header className="h-20 w-full flex items-center justify-between px-6 md:px-8 py-4 z-10 bg-background/50 backdrop-blur-md border-b border-white/5 sticky top-0">
            ...
            <div className="flex items-center gap-6">
                <button className="p-2 text-secondary hover:text-white transition-colors relative group">
                    <Bell size={20} />
                ...
                <div className="flex items-center gap-3 pl-6 border-l border-white/10 hidden md:flex">
